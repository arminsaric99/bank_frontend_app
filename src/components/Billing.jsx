    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          We are easily controlling your billing and invoicing. Everything is much more asier with us.
          Also we have mobile bank so you can pay your bills much more easier.
        </p>
